...
import pages.TradeAppTradePage;
import utilities.BrowserUtils;
import utilities.DBuilts;
import utilities.Driver;
import utilities.PropertiesReader;

public class TradeAppTrade {

	TradeAppTradePage tradePage = new TradeAppTradePage();
	BrowserUtils utils = new BrowserUtils();
	DBuilts dbUtils = new DBuilts();
	String stockSymbol;
	...
	public void i_search_the(String tradeSymbol) {
		...
		tradePage.searchBtn.sendKeys(tradeSymbol);
	}
